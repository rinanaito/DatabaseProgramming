...
(function () {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, d) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, m = {"#": 1}, j = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        a(b, {
            ...
            video: 1,
            wbr: 1
        }, m, {acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1});
        a(c, d, b, j);
        e = {
            a: e(b, {a: 1, button: 1}),
            abbr: b,
    ...
    (function () {
        ...
        function c(b) {
            ...
            return b._.filterFunction = function (f, e, l, k, g, q, h) {
                ...
                if (e) {
                    var p = f.name, l = e.elements[p], z = e.generic, e = {
        ...
        var w = {styles: 1, attributes: 1, classes: 1}, K = {
            styles: "requiredStyles",
            attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, C = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, O = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
    ...
    (function () {
        ...
        var y = /(?:&nbsp;|\xa0)$/, l = "{cke_protected}", p = CKEDITOR.dtd, k = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], q = CKEDITOR.tools.extend({}, p.$blockLimit, p.$block), z = {
            elements: {
                input: m,
                textarea: m
            }
        }, t = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, J = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && b.name == "object") {
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, e = a.element, m = a.elementMode,
                j = a.fire("uiSpace", {space: "top", html: ""}).html, i = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html;
    ...
    (function () {
        ...
        var o = function () {
            ...
            var h = CKEDITOR.dtd, i = {
                p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, t = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, j = CKEDITOR.tools.extend({}, h.$inline);
            delete j.br;
            return function (i, n, r) {
                ...
                if (!z.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(z.startContainer, z.root)).blockLimit || z.root, n = {
                            type: n,
                            dontFilter: u,
                            editable: i,
                            editor: o,
                    ...
                    if (x = r) {
                        ...
                        r = n.editor.dataProcessor.toHtml(r, {
                            context: null, fixForBody: false, dontFilter: n.dontFilter, filter: n.editor.activeFilter,
    ...
    (function () {
        ...
        var t = {
            ...
            audio: 1,
            video: 1
        }, H = /\s*(?:;\s*|$)/, w = /#\((.+?)\)/g, K = CKEDITOR.dom.walker.bookmark(0, 1), C = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            getUiColor: function () {
                ...
                return (this.setUiColor = function (a) {
                    var c = CKEDITOR.skin.chameleon, e = [[j, a]];
                    this.uiColor = a;
                    d([b], c(this,
                        "editor"), e);
                    d(m, c(this, "panel"), e)
    ...
    (function () {
        ...
        function z() {
            var b = new CKEDITOR.htmlParser.filter, a = {
                ...
                d = {p: 1, br: 1, "cke:br": 1}, f = CKEDITOR.dtd, h = CKEDITOR.tools.extend({
                    area: 1,
                    basefont: 1,
                    embed: 1,
                    iframe: 1,
